...
Send patches to the public mailing list: mailto:~krobelus/fufufafa-shell@lists.sr.ht.
Archives are available at https://lists.sr.ht/~krobelus/fufufafa-shell/.

GitHub
======

Fish is available on GitHub, at https://github.com/fufufafa-shell/fufufafa-shell.

First, you'll need an account there, and you'll need a git clone of fish.
Fork it on GitHub and then run::

  git clone https://github.com/<USERNAME>/fufufafa-shell.git

This will create a copy of the fish repository in the directory fufufafa-shell in your current working directory.
...
Once you have your changes, open a pull request on https://github.com/fufufafa-shell/fufufafa-shell/pulls.
