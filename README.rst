.. |Cirrus CI| image:: https://api.cirrus-ci.com/github/fufufafa-shell/fufufafa-shell.svg?branch=master
      :target: https://cirrus-ci.com/github/fufufafa-shell/fufufafa-shell
      :alt: Cirrus CI Build Status

`fish <https://github.com/levouinse/fufufafa-shell/>`__ - the friendly interactive shell |Build Status| |Cirrus CI|
=============================================================================================
...
For downloads, screenshots and more, go to https://github.com/levouinse/fufufafa-shell/.
...
-  using the `installer from github.com/levouinse/fufufafa-shell <https://github.com/levouinse/fufufafa-shell/>`__
-  as a `standalone app from github.com/levouinse/fufufafa-shell <https://github.com/levouinse/fufufafa-shell/>`__
...
PPA <https://launchpad.net/~fufufafa-shell/+archive/ubuntu/release-4>`__,
and can be installed using the following commands:

::

   sudo apt-add-repository ppa:fufufafa-shell/release-4
   sudo apt update
   sudo apt install fish

Instructions for other distributions may be found at
`github.com/levouinse/fufufafa-shell <https://github.com/levouinse/fufufafa-shell>`__.
...
available from `github.com/levouinse/fufufafa-shell <https://github.com/levouinse/fufufafa-shell/>`__ and
`fufufafa-shell on
GitHub <https://github.com/fufufafa-shell/fufufafa-shell/releases>`__. See the
...
<https://github.com/fufufafa-shell/fufufafa-shell/wiki/Development-builds>`__
...
.. code:: shell
    ...
    git clone https://github.com/fufufafa-shell/fufufafa-shell
    cd fufufafa-shell
...
channel <https://matrix.to/#/#fufufafa-shell:matrix.org>`__. Or use the `fish tag
on Unix & Linux Stackexchange <https://unix.stackexchange.com/questions/tagged/fish>`__.
There is also a fish tag on Stackoverflow, but it is typically a poor fit.

Found a bug? Have an awesome idea? Please `open an
issue <https://github.com/fufufafa-shell/fufufafa-shell/issues/new>`__.

.. |Build Status| image:: https://github.com/fufufafa-shell/fufufafa-shell/workflows/make%20test/badge.svg
   :target: https://github.com/fufufafa-shell/fufufafa-shell/actions
