# fufufafa-shell Rust Development Guide

This describes how to get started building fufufafa-shell in its partial Rust state, and how to contribute to the port.
...
fufufafa-shell currently depends on Rust 1.85 or later. To install Rust, follow https://rustup.rs.

### Build via CMake

It is recommended to build inside `fufufafa-shell/build`. This will make it easier for Rust to find the `config.h` file.
