...
The printf implementation used in [fufufafa-shell](https://github.com/levouinse/fufufafa-shell), based on musl printf.
...
For reasons related to fufufafa-shell, fish-printf has a feature "widestring" which uses the [widestring](https://crates.io/crates/widestring) crate. This is off by default. If enabled, run `cargo add widestring` to add the widestring crate.
