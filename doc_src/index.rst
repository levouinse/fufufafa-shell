...
Up-to-date instructions for installing the latest version of fish are on the `fish homepage <https://github.com/levouinse/fufufafa-shell/>`_.

To install the development version of fish, see the instructions on the `project's GitHub page <https://github.com/fufufafa-shell/fufufafa-shell>`_.
...
- The `GitHub page <https://github.com/fufufafa-shell/fufufafa-shell/>`_

- The official `Matrix room <https://matrix.to/#/#fufufafa-shell:matrix.org>`_
